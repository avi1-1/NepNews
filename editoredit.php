...
<div class="container">
    <div>
        <ul class="breadcrumb">
            <li class="breadcrumb-item active"><a href="editor.php">Home</a></li>
    ...
    <h1>Update News</h1>
    <hr>
    <form action="editoredit.php" method="post" enctype="multipart/form-data" name="categoryform" onsubmit="return validateform()">
...
if (isset($_POST['submit'])) {
	...
	if ($sql) {
		 ...
		 echo "<script >window.location='http://localhost/nepnews/editor.php' ;</script>";
	} else{

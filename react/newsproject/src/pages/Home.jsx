...
export const Home = () => {
    ...
    useEffect(() => {
        const fetchNews = async () => {
            try {
                const response = await fetch('http://localhost/NepNews/reactbackend/get_latest_news.php');
    ...
    const latestNews = news.slice(3, 7);
                    ...
                    {heroNews && (
                        <div className="flex flex-col md:flex-row w-full">
                            <div className="w-full md:w-1/2 mb-6 md:mb-0 md:pr-6">
                                <img
                                    src={`http://localhost/NepNews/images/${heroNews.thumbnail || 'default-news.jpg'}`}
                                    alt={heroNews.title}
                ...
                <section className="grid grid-cols-1 md:grid-cols-2 gap-8 px-6 mb-12">
                    {secondaryNews.map((item, index) => (
                        <div key={index} className="flex flex-col md:flex-row gap-6">
                            <div className="w-full md:w-1/2">
                                <img
                                    src={`http://localhost/NepNews/images/${item.thumbnail || 'default-news.jpg'}`}
                                    alt={item.title}
            ...
            <aside className="w-full md:w-1/4 p-6">
                <div className="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <div className="mt-6 bg-gray-100 p-8 rounded-md">
                        <p className="text-center text-gray-600">Ad Space</p>
                        <img
                            src="http://localhost/NepNews/images/your-ad-image.jpg"
                            alt="Advertisement"

...
// SQL query to fetch only 'draft' status news
$sql = "SELECT id, title, description, date, category, thumbnail, admin, status FROM news WHERE status = 'draft' ORDER BY id DESC";
